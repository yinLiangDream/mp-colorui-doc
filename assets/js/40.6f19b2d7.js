              ...
              [
                ...
                s("h3", { attrs: { id: "卡片类型" } }, [
                  s(
                    ...
                    {
                      staticClass: "header-anchor",
                      attrs: { href: "#卡片类型", "aria-hidden": "true" }
                    },
                    [t._v("#")]
                  ),
                  t._v(" 卡片类型")
                ...
                t._v(" "),
                s("h3", { attrs: { id: "card-参数" } }, [
                  s(
                    "a",
                    {
                      staticClass: "header-anchor",
                      attrs: { href: "#card-参数", "aria-hidden": "true" }
                    },
                    [t._v("#")]
                  ),
                  t._v(" Card 参数")
                ...
                s("table", [
                  ...
                  s("tbody", [
                    s("tr", [
                      s("td", [t._v("type")]),
                      t._v(" "),
                      s("td", [s("em", [t._v("卡片组件类型选择")])]),
                      t._v(" "),
                      s("td", [t._v("string")]),
                      t._v(" "),
                      s("td", [
                        s("em", [s("code", [t._v("card")])]),
                        t._v(","),
                        s("em", [s("code", [t._v("full")])])
                      ]),
                      t._v(" "),
                      s("td", [s("em", [s("code", [t._v("card")])])])
                    ]),
                    t._v(" "),
                    s("tr", [
                      s("td", [t._v("bgColor")]),
                      t._v(" "),
                      s("td", [s("em", [t._v("卡片背景色设置")])]),
                      t._v(" "),
                      s("td", [t._v("string")]),
                      t._v(" "),
                      s("td", [
                ...
                s("FloatPhone", {
                  attrs: {
                    url:
                      "https://yinliangdream.github.io/mp-colorui-h5-demo/#/pages/components/card/index"
                  }
                })
              ],
              1
