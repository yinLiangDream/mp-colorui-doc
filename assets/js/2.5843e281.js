  ...
  Array(57).concat([
        ...
        return function(e, s, d) {
          for (
            var v,
              ...
              y = a(b.length),
              _ = 0,
              k = n ? h(e, y) : u ? h(e, 0) : void 0;
            y > _;
            _++
          )
            if ((p || _ in b) && ((g = x((v = b[_]), _, m)), t))
              if (n) k[_] = g;
              else if (g)
                switch (t) {
                  case 3:
    ...
    function(t, e, n) {
      for (
        ...
        var g,
          ...
          x = a[m],
          y = x && x.prototype;
        if (y && (y[l] || s(y, l, p), y[f] || s(y, f, m), (u[m] = p), b))
    ...
    function(t, e, n) {
      ...
      var r = n(5),
        ...
        o = n(107),
        a = n(108);
      n(109)("match", 1, function(t, e, n, s) {
        return [
          function(n) {
            var r = t(this),
              i = null == n ? void 0 : n[e];
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e, n, d, v, g, m) {
        ...
        var b,
          ...
          L = !1,
          C = t.prototype,
          w = C[f] || C["@@iterator"] || (v && C[v]),
          O = w || _(v),
          $ = v ? (S ? _("entries") : O) : void 0,
          j = ("Array" == e && C.entries) || w;
        if (
          (j &&
            (y = l(j.call(new t()))) !== Object.prototype &&
            y.next &&
            (c(y, k, !0), r || "function" == typeof y[f] || a(y, f, h)),
          S &&
            w &&
            "values" !== w.name &&
            ((L = !0),
    ...
    function(t, e, n) {
      ...
      var r = n(5),
        ...
        p = /\$([$&`']|\d\d?|<[^>]*>)/g,
        h = /\$([$&`']|\d\d?)/g;
      n(109)("replace", 2, function(t, e, n, d) {
        return [
          function(r, i) {
            var o = t(this),
              a = null == r ? void 0 : r[e];
          ...
          function(t, e) {
            ...
            for (var b = []; ; ) {
              ...
              if (null === x) break;
              if ((b.push(x), !g)) break;
              "" === String(x[0]) && (f.lastIndex = s(p, o(f.lastIndex), m));
            }
            for (var y, _ = "", k = 0, S = 0; S < b.length; S++) {
              x = b[S];
              for (
                var L = String(x[0]),
                  C = c(l(a(x.index), p.length), 0),
                  w = [],
                  O = 1;
                O < x.length;
                O++
              )
                w.push(void 0 === (y = x[O]) ? y : String(y));
              var $ = x.groups;
              if (h) {
                var j = [L].concat(w, C, p);
                void 0 !== $ && j.push($);
                var A = String(e.apply(void 0, j));
              } else A = v(L, p, C, w, $, e);
              C >= k && ((_ += p.slice(k, C) + A), (k = C + L.length));
            }
            return _ + p.slice(k);
          }
        ];
    ...
    function(t, e, n) {
      ...
      var r = n(59),
        i = {
          ...
          components: { DropdownTransition: n(133).a },
          beforeCreate: function() {
            this.$options.components.SidebarLinks = n(132).default;
          },
    ...
    function(t, e, n) {
      n(159), (t.exports = n(63).Array.isArray);
    },
    function(t, e, n) {
      var r = n(79);
      r(r.S, "Array", { isArray: n(163) });
    },
    function(t, e) {
      t.exports = function(t) {
    ...
    function(t, e, n) {
      n(115), n(178), (t.exports = n(63).Array.from);
    },
    function(t, e, n) {
      var r = n(83),
        i = n(84);
    ...
    function(t, e, n) {
      var r = n(124),
        i = n(58)("iterator"),
        o = n(64);
      t.exports = n(63).isIterable = function(t) {
        var e = Object(t);
    ...
    function(t, e, n) {
                ...
                for (
                  ...
                  if (this.getPageLocalePath(a) === n && this.isSearchable(a))
                    if (r(a)) i.push(a);
                      ...
                      for (
                        var s = 0;
                        s < a.headers.length && !(i.length >= 10);
                        s++
                      ) {
                        var u = a.headers[s];
                        r(u) &&
      ...
      n(125), n(126);
      var x = {
          components: { NavLink: a, DropdownTransition: n(133).a },
          data: function() {
            return { open: !1 };
          },
          props: { item: { required: !0 } },
      ...
      var S = {
          ...
          mounted: function() {
            var t = this,
              e =
                parseInt(k(this.$el, "paddingLeft")) +
                parseInt(k(this.$el, "paddingRight")),
              n = function() {
        ...
        T = {
          ...
          computed: {
            prev: function() {
              return P(E.PREV, this);
            },
            next: function() {
              return P(E.NEXT, this);
            }
          }
        };
      var E = {
      ...
      var M = T,
        ...
        R = {
          name: "Sidebar",
          components: { SidebarLinks: n(132).default, NavLinks: _ },
          props: ["items"]
        },
        G = (n(210),
        {
